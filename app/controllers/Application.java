...
public class Application extends Controller {
	...
	public static Result FORGET_PASS_HOME 		= redirect(routes.Application.forgetPassPage());
	
    public static Result index() {
        return ok(views.html.index.render("Your new application is ready.", searchForm));
    }
    ...
    public static Result forgetPassword(){
		...
		flash("success", String.format("Nous avons envoyé votre mot de pass à l'adresse mail : "  + user.email));
...
// -- Authentication
    ...
    public static Result login() {
        return ok(
        		views.html.login.render(Form.form(Login.class), searchForm)
        );
    }
    ...
    public static Result authenticate() {
        ...
        if(loginForm.hasErrors()) {
            ...
            session("permissionUser", String.valueOf(user.permission.idPermission));
